...
type ProductService interface {
	...
	FindAll(ctx context.Context, in *RequestAll, opts ...client.CallOption) (*AllProduct, error)
}
...
func (c *productService) FindAll(ctx context.Context, in *RequestAll, opts ...client.CallOption) (*AllProduct, error) {
...
type ProductHandler interface {
	...
	FindAll(context.Context, *RequestAll, *AllProduct) error
}
...
func RegisterProductHandler(s server.Server, hdlr ProductHandler, opts ...server.HandlerOption) error {
	type product interface {
		...
		FindAll(ctx context.Context, in *RequestAll, out *AllProduct) error
	}
	type Product struct {
		product
	}
...
func (h *productHandler) FindAll(ctx context.Context, in *RequestAll, out *AllProduct) error {
